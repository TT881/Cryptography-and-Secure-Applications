...
public class LDESEncryption {  
    ...
    public static void main(String[] args) 
    {
        ...
        {   
            ...
            System.out.println(j+1 + ". Encrypt the below using Key: "+ ToBinary2Bit(K[j]));  //00,01,10,11
            System.out.println("=======================================");
            for ( int i = 0; i < 16; i++  )
            {
                System.out.print("Input 4 bits Message(M) : "+ ToBinary(i));
